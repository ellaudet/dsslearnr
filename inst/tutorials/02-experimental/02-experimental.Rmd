...
quiz(caption="",
  ...
  question("<span style=color:dodgerblue> Q3:</span> ",
    ...
    question("<span style=color:dodgerblue> Q4: </span> Suppose you woke up with a headache today. At 9 AM the intensity of the headache was 5 (in a scale of 1 to 5, where 1 is not very intense and 5 is extremelly intense). By 10 AM, someone offered you an aspirin and you decided to take it with a glass of water. By 12 PM, you were feeling better and the intensity of the headache had gone down to 3. Given this setup, could we estimate the effect that the aspirin had on your level of headache?",
    answer("No, we have no idea whether the reduccion in the level of intensity of the headache was due to (a) the aspirin, (b) the water that was consumed with the aspirin (perhaps the headache was due to dehydration), (c ) the passing of time, or (d) a combination of the above.", correct = TRUE),
    answer("Yes, we can estimate that the aspirin reduced the level of intensity of the headache by two units, by decreasing it from 5 to 3 (in a scale of 1 to 5)."),
    post_message = "In this scenario, we get to observe the intensity of your headache at 12 PM after having taken an aspirin and a glass of water at 10 AM. This is what is known as the potential outcome under the treatment condition.<br><br> We do not get to observe, however, the intensity of your headache at 12 PM after only having a glass of water at 10 AM, without the aspirin. This is what is known as the potential outcome under the control condition.<br><br>To be able to estimate the causal affect of the aspirin on your level of headache, we would have to observe both potential outcomes so that we could compare them. Unfortunately, we only observe the potential outcome that occurs in reality (the factual outcome), and we never get to observe the potential outcome that would have happened under the oposite treatment condition as the one that occurred in reality (the counterfactual outcome). As a result, we cannot compute causal effects at the individual level.",
    random_answer_order = TRUE,
    allow_retry = TRUE
  ),
