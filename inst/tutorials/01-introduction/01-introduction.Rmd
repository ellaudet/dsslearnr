...
question("<span style=color:dodgerblue> Q3: </span>How do we run code that has already been written on an R script?",
  ...
  question("<span style=color:dodgerblue> Q4: </span>Which of the following pieces of R code will compute 3 + 3?",
    ...
    <br><br> For more information on how to do calculations in R, review subsection 1.6.1 of DSS.",
    random_answer_order = TRUE,
    allow_retry = TRUE
  ),
  question("<span style=color:dodgerblue> Q5: </span>Which of the following pieces of R code will create an object called *three* containing the number 3?",
    ...
    For more information on how to create objects in R, review subsection 1.6.2 of DSS.",
    random_answer_order = TRUE,
    allow_retry = TRUE
  ),
  question("<span style=color:dodgerblue> Q6: </span>Which of the following pieces of R code will create an object called *today* containing the text *Monday*?",
    ...
    For more information on when we use quotes when writting R code, review the callout shown in a cyan-colored frame in the margin of page 11 of DSS.",
    random_answer_order = TRUE,
    allow_retry = TRUE
  ),
  ...
  question("<span style=color:dodgerblue> Q10 - A MULTI-ANSWER QUESTION: </span> If we had run all the code above, which of the following pieces of R code could we use to compute the square root of 3? (Note: You must select ALL true statements for the answer to be correct.)",
    ...
    <br><br> For more information on now to use the `sqrt()` function, review the bottom half of page 13 of DSS.",
    random_answer_order = TRUE,
    allow_retry = TRUE
  ),
  question("<span style=color:dodgerblue> Q11: </span>What would happen if after running all the code above, we ran the following piece of R code: ` # square root of three is sqrt(three)`",
    ...
    <br><br>
    For more information on how the `#` character works, review page 14 of DSS.",
    random_answer_order = TRUE,
    allow_retry = TRUE
  ),
...
Hint: You may want to review how to use the assignment operator `<-` in subsection 1.6.2 of DSS.
</div>
...
quiz(caption="",
  question("<span style=color:dodgerblue> Q1: </span>In a dataframe,...",
    ...
    post_message = "In a dataframe, rows are observations and columns are variables. (See page 18 of DSS.)",
    random_answer_order = TRUE,
    allow_retry = TRUE
  ),
  question("<span style=color:dodgerblue> Q2: </span>The unit of observation...",
    ...
    Examples: students, schools, states, countries,... (See page 18 of DSS.)",
    random_answer_order = TRUE,
    allow_retry = TRUE
  ),
  question("<span style=color:dodgerblue> Q3: </span>In mathematical notation, *i* ...",
    ...
    Example: the observation for which *i*=3 is the third observation in a dataframe or in a variable. (See page 18 of DSS.)",
    random_answer_order = TRUE,
    allow_retry = TRUE
  ),
    ...
    post_message = "Here *names* is a character variable because it contains text. (See pages 18-20 of DSS.)",
    random_answer_order = TRUE,
    allow_retry = TRUE
  ),
    ...
    post_message = "Here *voted* is a numeric binary variable because it contains numbers and it can take only two values: 0s and 1s, where 0 means 'no' and 1 means 'yes'. (See pages 18-20 of DSS.)",
    random_answer_order = TRUE,
    allow_retry = TRUE
  ),
    ...
    answer("an observation"),
    post_message = "Here *length* is a numeric non-binary variable because it contains numbers (not text), and it can clearly take more than two values. (See pages 18-20 of DSS.)",
    random_answer_order = TRUE,
    allow_retry = TRUE
  ),
    ...
    Note: As soon as a variable contains some text, even if it also contains numbers, it will be a character variable and we won't be able to do math with it. (See pages 18-20 of DSS.)",
    random_answer_order = TRUE,
    allow_retry = TRUE
  ),
    ...
    post_message = "In mathematical notation, *n* stands for the total number of observations.<br><br> Here *id* has five observations so *n*=5. (See pages 18-21 of DSS.)",
    random_answer_order = TRUE,
    allow_retry = TRUE
  ),
...
<br><br> For more information on how to create objects in R, review subsection 1.6.2 of DSS. And, for more information on how to use the `read.csv()` function, review step #2 of the section 1.7 of DSS. ",
    random_answer_order = TRUE,
    allow_retry = TRUE
  ),
  question("<span style=color:dodgerblue> Q13 - A MULTI-ANSWER QUESTION: </span> If we wanted to take a look at the data stored in the object called *grades*, we could run... (Note: You must select ALL true statements for the answer to be correct.)",
    ...
    post_message = "We could run either  `View(grades)` or `head(grades)`.<br><br> The first piece of code will open a new tab in the upper-left window of RStudio with the contents of the dataset. The second will show the first six rows or observations in the dataset. <br><br> For more information, review step #3 of section 1.7 of DSS.",
    random_answer_order = TRUE,
    allow_retry = TRUE
  ),
 ...
 For more information on the `dim()` function, review step #5 of the section 1.7 of DSS.",
    random_answer_order = TRUE,
    allow_retry = TRUE
  ))
```
...
```{r topic2_r1-check}
grade_code("<br><br>For more information, review step #3 of section 1.7 of DSS.")
```
...
Hint: You may want to review how to set the optional argument named `n` when using the `head()` function. (See the bottom half of page 17 of DSS.) 
</div>
...
```{r topic2_r2-check}
grade_code("<br><br> For more information on how to specify optional arguments in R functions, review subsection 1.6.3 of DSS. For more information on how to set the optional argument named `n` when using the `head()` function, review the bottom half of page 17 of DSS.")
```
...
quiz(caption="",
    ...
    For the defintions of the different types of variables discussed here, review step #4 of section 1.7 of DSS.",
    random_answer_order = TRUE,
    allow_retry = TRUE
  ),
...
Hint: You may want to review how the `dim()` function works in step #5 of section 1.7 of DSS.
</div>
...
```{r topic2_r3-check}
grade_code("For more information, review how the `dim()` function works in step #5 of section 1.7 of DSS.")
```
...
quiz(caption="",
    ...
    <br><br>For more information, review how the `dim()` function works in step #5 of section 1.7 of DSS.",
    random_answer_order = TRUE,
    allow_retry = TRUE
  ))
```
...
quiz(caption="",
  ...
  For more information on how to compute and interpret means, review subsection 1.8.2 of DSS.",
    random_answer_order = TRUE,
    allow_retry = TRUE
  ),
    ...
    post_message = "The correct answer is: $\\sum$ stands for summation.<br><br> For more info, review subsection 1.8.2 of DSS.",
    random_answer_order = TRUE,
    allow_retry = TRUE
  ),
...
question("<span style=color:dodgerblue> Q4: </span>If the unit of observation is students and *attended* = {0, 0, 1, 1, 1, 0}, what is $\\overline{attended}$ ?",
  ...
  <br><br>For more information on how to interpret the mean of non-binary variables, review subsection 1.8.2 of DSS.",
   ...
   For more information on how to access variables inside of dataframes, review how to use the `$` character in subsection 1.8.1 of DSS.",
    random_answer_order = TRUE,
    allow_retry = TRUE
  )
)
...
<br> <span style=color:dodgerblue> **Q1:** </span> **Use the `mean()` function to compute the mean of the variable *reading* **
