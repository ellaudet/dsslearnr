...
<br> <span style=color:dodgerblue> **SETUP: **</span> **Go ahead and run the code below to ask R to show the first six observations in the dataframe stored in the `star` object:**
 
```{r r7B, exercise=TRUE, exercise.setup = "star"}
