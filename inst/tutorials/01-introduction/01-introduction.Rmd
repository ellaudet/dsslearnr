...
```{r quiz2B}
quiz(caption="",
       question("<span style=color:dodgerblue> Q3: </span>Looking at the output above, we can see that ....",
  ...
  question("<span style=color:dodgerblue> Q4: </span>Looking at the output above, we can substantively interpret the first observation. The first observation represents: ....",
...
<br> <span style=color:dodgerblue> **Q5:** </span> **Now, use the `dim()` function to ask R what the dimensions of the object `star` are**
...
```{r quiz2C}
quiz(caption="",
       question("<span style=color:dodgerblue> Q6: </span>Looking at the output above, we can see that...",
...
```{r quiz2DF}
quiz(caption="",
       question("<span style=color:dodgerblue> Q2: </span> How can we interpret the mean of *reading* computed above?",
...
<br> <span style=color:dodgerblue> **Q3:** </span> **Now, use the `mean()` function again, but this time to compute the mean of the variable *graduated*, which is also stored inside of the object `star`. (Hint: The `$` character might be helpful here)**
...
```{r quiz2E}
quiz(caption="",
       question("<span style=color:dodgerblue> Q4: </span> How can we interpret the mean of *graduated* computed above?",
